<div class="row">
    <div class="col-4 col-sm-3">
        <p class="text-muted mb-0" title="{{ $last_match->trading_price_normalized }}">
            <i class="fa fa-gavel text-dark" aria-hidden="true"></i>
            Last Price
        </p>
        @if($last_match)
        <p class="mb-0">{{ number_format($last_match->trading_price_normalized) }} {{ explode('/', $last_match->trading_pair_normalized)[1] }}</p>
        @endif
    </div>
    <div class="col-4 col-sm-3">
